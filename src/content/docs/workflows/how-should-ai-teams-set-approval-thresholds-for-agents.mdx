...
description: Set AI agent approval thresholds by consequence, reversibility, authority, evidence quality, and review capacity instead of vague confidence scores.
