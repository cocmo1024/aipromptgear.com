...
description: A practical confirmation rule for AI agents covering irreversible actions, ambiguous intent, policy-sensitive cases, and when asking for confirmation protects trust instead of creating friction.
