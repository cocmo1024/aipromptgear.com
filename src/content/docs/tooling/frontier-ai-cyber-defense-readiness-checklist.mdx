...
This checklist responds to current defensive-cyber signals from [OpenAI's trusted-access work with GPT-5.5 and GPT-5.5-Cyber](https://openai.com/index/gpt-5-5-with-trusted-access-for-cyber/) and Anthropic's [Project Glasswing](https://www.anthropic.com/project/glasswing), both of which frame advanced AI cyber capability as controlled, defensive, and access-governed rather than a general-purpose open workflow.
