...
description: What a prompt comparison tool should compare before release, including behavior diffs, regression cases, grounding changes, model routing, approval boundaries, and rollback readiness.
