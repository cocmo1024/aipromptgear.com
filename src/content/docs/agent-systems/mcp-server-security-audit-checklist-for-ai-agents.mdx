...
description: Audit MCP servers exposed to AI agents across tool scopes, prompt injection, SSRF, browser automation, credentials, approvals, logs, and incidents.
