...
description: Design AI agent audit trails covering run identity, approvals, evidence, tool actions, side effects, reviewer decisions, and investigation needs.
