---
title: What Is EvalOps? Definition, Workflow, and Release Gates for AI Teams
description: A practical EvalOps definition for AI teams, with datasets, traces, graders, scorecards, release gates, ownership, monitoring, and rollback rules.
...
<div class="portal-links">
	<LinkCard
		...
		description="Use this page when the team needs a staged path from traces and scorecards to real release gates."
	/>
	<LinkCard
