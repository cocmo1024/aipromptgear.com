---
title: How to use OpenAI background mode for long-running AI tasks
description: Build a background processing AI system with OpenAI background mode, including async jobs, status tracking, tool work, approvals, and failure handling.
...
# How to use OpenAI background mode for long-running AI tasks
