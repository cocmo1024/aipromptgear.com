...
When the blocker is broader than one OpenAI runtime lane, use the [private and sovereign AI architecture guide](/models-and-apis/private-and-sovereign-ai-architecture-for-enterprise-agents/) to separate data residency, regional inference, trace retention, and vendor evidence requirements before choosing an agent platform.
...
<div class="portal-links">
	...
	<LinkCard
		...
		description="Use this page when privacy, residency, regional inference, or trace retention requirements affect the entire agent architecture."
	/>
</div>
