---
title: "OpenAI Batch API Pricing: 50% Discount and Workload Fit"
description: How OpenAI Batch API pricing works, when the 50% input and output discount matters, and which workloads should use Batch instead of live, flex, or background lanes.
