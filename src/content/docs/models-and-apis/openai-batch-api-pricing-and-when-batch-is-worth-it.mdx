---
title: "OpenAI Batch API Pricing: When the 50% Discount Is Worth It"
description: How OpenAI Batch API pricing works, when the 50% input and output discount matters, and which AI workloads should use Batch instead of live or background lanes.
...
primaryKeyword: openai batch api pricing
...
- [OpenAI API pricing](https://openai.com/api/pricing/) positions Batch API as a service tier that saves 50 percent on inputs and outputs for eligible asynchronous work.
- [OpenAI Batch API documentation](https://platform.openai.com/docs/guides/batch) describes Batch as a way to process asynchronous groups of requests with a 24-hour completion window and separate batch limits.
