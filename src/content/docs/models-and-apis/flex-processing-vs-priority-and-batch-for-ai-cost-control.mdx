---
title: OpenAI Batch vs Flex vs Priority Processing for API Cost Control
description: Compare OpenAI Batch API, Flex processing, and Priority processing by cost, latency, reliability, queue design, and workload class.
...
| [OpenAI API pricing](https://openai.com/api/pricing/) | Flex processing trades lower price for slower response and occasional resource unavailability | Flex is a queueing and reliability decision, not just a discount |
