...
- Keep robots, sitemap, and [crawler access policy](/models-and-apis/ai-crawler-access-policy-robots-txt-gptbot-google-extended/) intentional.
...
<div class="portal-links">
	...
	<LinkCard
		...
		description="Decide how robots.txt, GPTBot, OAI-SearchBot, Google-Extended, CCBot, Content Signals, and bot controls should work together."
	/>
	<LinkCard
