...
| --- | --- | --- |
| [OpenAI Batch guide](https://platform.openai.com/docs/guides/batch) | Batch is documented for large asynchronous request sets with lower-cost deferred execution | It is built for backlog processing, not live user waiting loops |
