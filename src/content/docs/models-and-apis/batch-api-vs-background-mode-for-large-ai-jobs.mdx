...
| --- | --- | --- |
| [OpenAI Batch guide](https://platform.openai.com/docs/guides/batch) | Batch is documented for large asynchronous request sets, separate batch rate limits, and completion within a 24-hour window | It is built for backlog processing, not live user waiting loops |
| [OpenAI API pricing](https://openai.com/api/pricing/) | OpenAI publicly positions Batch as a lower-cost lane for eligible asynchronous workloads | Deferred bulk jobs can have very different economics from live requests |
