...
description: How to decide whether repeated context, changing knowledge, or model behavior drift should be solved with prompt caching, retrieval, or fine-tuning.
