---
title: "OpenAI Background Mode: Polling, Webhooks, and Job Status"
...
<div class="portal-links">
	<LinkCard
		...
		description="Use this page when enterprise data-control requirements decide whether background mode is allowed for the workload."
	/>
	<LinkCard
	...
	<LinkCard
		...
		description="See polling, cancellation, retry, and review states applied to a concrete long-running research report workflow."
	/>
	<LinkCard
...
This page was refreshed against OpenAI's [background mode guide](https://platform.openai.com/docs/guides/background), including background response creation, polling, cancellation, streaming, and stored response-state limits. The page focuses on the product job lifecycle that should surround those API primitives.
